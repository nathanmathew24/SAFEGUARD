...
class DebitNote(LockableMixin, db.Model):
    ...
    invoice = db.relationship("Invoice", back_populates="debit_notes")
    customer = db.relationship("Customer", lazy="joined")
    line_items = db.relationship("LineItem", foreign_keys="LineItem.debit_note_id",
                                 backref="debit_note", lazy="select", cascade="all, delete-orphan")
